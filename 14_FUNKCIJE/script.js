...
zbir1(5, 6);
//console.log(a);
//console.log(b); - ove dve linije ne rade, jer promenljive a i b ne postoje!
let a = -3;
let b = 7;
zbir1(a, b);
console.log(a);  // a = -3
...
console.log(max4DN(4, -6, 10, 3));
console.log(max4TN(4, -6, 10, 3));
